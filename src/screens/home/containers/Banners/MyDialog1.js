...
const MyDialog1 = () => {
  ...
  return (
    ...
    <View style={styles.container}>
        ...
        ><Image source={{uri: 'https://hardware.marvytech.co.in/wp-content/uploads/2022/12/cctv-6.png'}}
        style={{width: 36, height: 36,center:true}} />
          <Text> Get Surveillance </Text>
        </TouchableOpacity>
      <Modal visible={isDialogVisible} 
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={{textAlign:'center'}}>Get Surveillance</Text>
          <Input
                    label="Username"
                    value={inputValue}
