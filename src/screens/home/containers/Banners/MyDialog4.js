  ...
  return (
    ...
    <View style={styles.container}>
        <TouchableOpacity
          ...
          ><Image source={{uri: 'https://hardware.marvytech.co.in/wp-content/uploads/2022/12/track.png'}}
      ...
      <Modal visible={isDialogVisible} 
        ...
        <View style={styles.centeredView}>
          ...
          <Text style={{textAlign:'center'}}>Track Order</Text>
          <Input
                    label="Order ID"
                    value={inputValue}
